...
inline void shader_create(std::unique_ptr<Shader>& self, const char* vert, const char* frag)
{
...
inline void shader_use(std::unique_ptr<Shader>& self)
{
	glUseProgram(self->handle);
}

inline void shader_delete(std::unique_ptr<Shader>& self)
{
	glDeleteProgram(self->handle);
}

inline void setMatrix4f(std::unique_ptr<Shader>& shader, const char* name, glm::mat4 matrix)
{
